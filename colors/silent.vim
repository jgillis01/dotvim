...
hi Pmenu            ctermbg=white ctermfg=white guibg=#DDDDDD guifg=Black gui=italic
...
hi rubySymbol   ctermfg=53 gui=NONE
hi StorageClass ctermfg=DarkBlue gui=bold
hi Structure    ctermfg=DarkBlue gui=bold
hi TypeDef      ctermfg=DarkBlue gui=bold
hi RubyConstant      ctermfg=53 gui=bold
hi Folded           ctermfg=Grey ctermfg=White guibg=#F1FFC1 guifg=#101010 gui=italic
hi Error	        term=standout ctermbg=Red ctermfg=White guibg=#D80000 guifg=#FFD1CC gui=NONE
